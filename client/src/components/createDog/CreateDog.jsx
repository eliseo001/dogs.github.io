        ...
        <div className="container">
          ...
          onSubmit={(e) => Submit(e)}>
            <div><label>Name: </label>
                        ...
                        <label>Height: </label>
                                <input className="input" onChange={(e) => Change(e)} name="min_height" type="min_height" value={input.min_height} placeholder="Min height"
                                />
                                {errors.min_height && (
                                    <p className="error">{errors.min_height}</p>
                                )} 
                                <input className="input" onChange={(e) => Change(e)} name="max_height" type="max_height" value={input.max_height} placeholder="Max height"
                                />  
                                {errors.max_height && (
                        ...
                        <div className="minMax">
                        <label>Weight: </label>
                                <input className="input" onChange={(e) => Change(e)} name="min_weight" type="min_weight" value={input.min_weight} placeholder="Min weight"
                                />
                                {errors.min_weight && (
                                    <p className="error">{errors.min_weight}</p>
                                )} 
                                <input className="input" onChange={(e) => Change(e)} name="max_weight" type="max_weight" value={input.max_weight} placeholder="Max weight"
                                />
                                {errors.max_weight && (
                        ...
                        <div className="temps"> <label>Choose Temperaments: </label>
                        <select className="templist" name="temperament" onChange={(e) => Select(e)}  type="text" >
                                ...
                                { temps.map((temp, id) =>{   
                                    return ( 
                                        <React.Fragment key={id}>   
                                            ...
                                            <button className="btnTemp" value={temp} onClick={(e) => Delete(e)}>x</button>
                                            </div>
